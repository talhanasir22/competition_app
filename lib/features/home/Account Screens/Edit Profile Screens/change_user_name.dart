...
class _ChangeUserNameState extends State<ChangeUserName> {
  ...
  Future<void> _updateUsername() async {
    ...
    try {
      ...
      if (user == null) {
        Fluttertoast.showToast(msg: "User not authenticated. Please log in.");
        setState(() {
          _isLoading = false;
        });
      ...
      bool isUnique = await _db.isUsernameUnique(newUsername);
      ...
      // Proceed with updating username only if unique
      await _db.updateUsername(newUsername);
